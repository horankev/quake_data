...
Sourced from the [USGS eathquake catalogue API](https://earthquake.usgs.gov/earthquakes/search/). More detailed attribute descriptions available [here](https://earthquake.usgs.gov/data/comcat/index.php#1).
